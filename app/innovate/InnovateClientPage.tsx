...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Emerging trends and technologies that are reshaping how we build and interact with mobile applications.",
    date: "March 10, 2025",
    image:
  ...
  },
  {
    ...
    excerpt: "A comprehensive guide to different funding options and how to prepare your startup for investment.",
...
const processSteps = [
  ...
  },
  {
    icon: DollarSign,
    title: "Funding",
    description: "Access capital through our network of investors or explore our sweat equity partnership model.",
  },
]
...
export default function InnovateClientPage() {
    ...
    <main className="min-h-screen bg-background">
            ...
            {processSteps.map((step, index) => (
              ...
              >
                <div className="w-10 h-10 md:w-12 md:h-12 mb-4 md:mb-6 relative">
                  <div className="absolute inset-0 bg-primary/20 rounded-full blur-md" aria-hidden="true" />
            ...
            {successStories.map((project, index) => (
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-deep-black via-transparent to-transparent opacity-80"
                    aria-hidden="true"
                  />
                </div>
      ...
      <section className="py-20 bg-deep-black">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <Suspense fallback={<div className="text-center py-8">Loading FAQs...</div>}>
